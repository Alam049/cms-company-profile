...
interface CreateOverviewProps {
  setOpen: (open: boolean) => void;
}

export default function CreateOverview({setOpen}: CreateOverviewProps) {
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
          <div className="grid grid-cols-1 gap-4">
            ...
            <div className="space-y-2">
              ...
              <Select onValueChange={(value) => setValue("status", value as "pending" | "processing" | "success" | "failed")}> 
                <SelectTrigger>
      ...
      <Dialog open={modal.open} onOpenChange={() => setModal({ open: false, type: null })}>
        <DialogContent>
          ...
          <p className="text-gray-600">
            {modal.type === "success" ? "Your payment has been successfully processed." : "There was an error processing your payment. Please try again."}
          </p>
        </DialogContent>
      </Dialog>
    </div>
